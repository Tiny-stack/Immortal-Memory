...
// import backend.records.Ressponse;
...
public class MemoryController {
    ...
    private void saveMemory()
    {
            ...
            String memory = Shared.cr.encryptText(content);
            title = Shared.cr.encryptText(title);
            ...
            {
                Shared.ui.showMessage("ERROR", "Unable to save Memory");
            }
    ...
    private void nextMemory()
    {
        ...
        if(mem!=null)
        {
            ...
            Helper.setBodyContent(Shared.cr.decryptText(mem.getContent()), memoryEditor);
    ...
    private boolean checkChangesAndProceed()
    {
        ...
        {
           int res = Shared.ui.showYesNoDialog("Unasaved Changes", "Save Changes...?","You have unsaved Changes, Save Changes..?");
           if(res==1)
           {
                this.saveMemory();
                return true;
    ...
    {
        Shared.ui.loadMainMenuScreen(cr);
    }
}
