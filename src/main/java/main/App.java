...
import frontend.ui.AppController;
import javafx.util.Duration;
import frontend.ui.MainMenu;
...
public class App extends Application {
    ...
    public void changeToAnotherScene(String loaderPath) throws Exception {
        ...
        FXMLLoader newLoader = new FXMLLoader(getClass().getResource(loaderPath));
        Parent newRoot = newLoader.load();
    
        Scene currentScene = this.stage.getScene();
        
        // if (currentScene != null && currentScene.getRoot() != null) {
        //     // Replace the old scene root to release references
        //     currentScene.setRoot(new Group());
        // }
        ...
        fadeOut.setOnFinished(event -> {
            Scene newScene = new Scene(newRoot, this.stage.getWidth(), this.stage.getHeight());
            this.stage.setScene(newScene);
